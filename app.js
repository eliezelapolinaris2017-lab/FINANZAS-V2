...
/* =========================================================
   ...
   Nómina con retenciones, Facturas, Cotizaciones, Ordinarios,
...
/* =========================================================
   ...
   Reportes/Inicio, Export/Import JSON, PDF jsPDF, Conciliación,
...
function cloudSubscribe(){
  ...
  cloud.unsub = onSnapshot(ref,(snap)=>{
    ...
    if((remote?._cloud?.updatedAt||0)>(state?._cloud?.updatedAt||0)){
      state=remote; save({skipCloud:true}); toast('Actualizado desde la nube');
    }
  });
}
...
function wireAll(){
  ...
  wireCloudUI(); updateLoginUI(); wireHistorySearch(); wireReconciliationImport();
  initCatalogs(); applyTheme(); refreshAll(); showView('login');
}
